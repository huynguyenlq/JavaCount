...
public class OnSubTaskDoneFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    public static final String FIELD_MESSAGE = "messageField";

    private WorkflowManager workflowManager;

    public OnSubTaskDoneFactory(WorkflowManager workflowManager) {
